...
namespace Knowte.Common.Base
{
    public class ProductInformation
    {
        ...
        public static string ApplicationName = "DiME Writing";
        public static string ApplicationNameUppercase = "DIME WRITING";
        public static string Copyright = "ELX Lab @ University of Florida " + DateTime.Now.Year;
